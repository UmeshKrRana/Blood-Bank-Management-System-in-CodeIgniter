...
<div class="container pt-5 pb-5">
			...
			<!-- breadcrumb -->
                <ol class="breadcrumb bg-transparent mt-4 border-bottom">
                  ...
                  <li class="breadcrumb-item">
                    <a class="nav-item active"> Receiver Login </a>
                  </li>
                </ol>
            <!-- breadcrumb ends -->
               ...
               ?>
                          <?php echo form_open('receiver/login_success');?>
                            <div class="row pt-4">
                              <div class="col-md-6 m-auto shadow border-top p-4">
                                <div class="form-group">
                                  <?php echo form_label('Mobile no *', 'mobile', ['class'=>'text-danger w-100 text-left']);?>
                              <?php echo form_input(['name'=>'mobile', 'id'=>'mobile', 'class'=>'form-control', 'placeholder'=>'Mobile number', 'required'=>'']);?>
                              </div>
                            ...
                            <div class="form-group">
                              <?php echo form_submit(['name'=>'register', 'id'=>'register', 'class'=>'btn btn-success', 'value'=>'Login']);?> &nbsp;
                               ...
                               <span> Not Registered? <?php echo anchor('registration/receiver_registration','Register Here', ['class'=>'pt-4 font-weight-normal']); ?></span>
                            </div>
